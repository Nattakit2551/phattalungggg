...
/* วิดีโอพื้นหลังหน้าแรก — เฟดเข้าเมื่อเล่นได้ / ถ้าเล่นไม่ได้ใช้ภาพนิ่งแทน */
(function(){
  ...
  /* บางเบราว์เซอร์บล็อก autoplay → ลองสั่งเล่น ถ้าไม่ได้ก็ใช้ภาพนิ่ง */
  const tryPlay = v.play();
  if(tryPlay && tryPlay.catch) tryPlay.catch(()=>hide());

  /* ถ้า 4 วินาทีแล้วยังเล่นไม่ได้ ใช้ภาพนิ่ง */
